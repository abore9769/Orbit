...
//!
//! This module defines the stable conceptual model for Orbit's Soroban-first ECS path:
//!
...
/// Supported runtime backends for Orbit's ECS layer.
...
/// Shared read-only runtime contract for Orbit world backends.
///
...
/// Shared mutable runtime contract for Orbit's Soroban-first world backends.
///
