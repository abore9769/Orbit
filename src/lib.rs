#![no_std]
#![doc = r#"
Orbit is a monolithic-on-the-outside ECS framework for Soroban-compatible applications.
...
use orbit_core::{Position, SystemConfig};
use soroban_sdk::Env;
...
/// Default gameplay runtime surface for new Orbit projects.
pub mod app {
    pub use super::{
