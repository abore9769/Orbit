...
/// # Example
/// ```no_run
/// # use orbit_core::accounts::{BatchBuilder, OrbitAccount, GameAction};
/// # use soroban_sdk::{symbol_short, Bytes, Env};
/// # fn run<A: OrbitAccount>(env: &Env, account: &A) -> Result<(), orbit_core::accounts::AccountError> {
