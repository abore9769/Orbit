//! Account abstraction for Orbit game accounts.
//!
...
//!
//! ```no_run
//! use orbit_core::accounts::{ClassicAccount, OrbitAccount, GameAction};
...
//! # Ok::<(), orbit_core::accounts::AccountError>(())
//! ```
...
pub use traits::{OrbitAccount, IntentAccount, SessionKeyProvider};
