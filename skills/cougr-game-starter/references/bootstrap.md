...
Use this reference when starting a fresh project that will depend on `orbit-core`.
...
- compile cleanly
- express game state in a Orbit-friendly structure
...
If the user does not specify otherwise, prefer the published `orbit-core`
